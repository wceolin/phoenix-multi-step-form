defmodule MultiStepWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MultiStepWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MultiStepWeb.Gettext, "errors", msg, opts)
    end
  end
